import { getChars, getWords, setShadow } from '../../util';
...
function measureLines(canvas: Vuvas, chars: readonly string[], boxWidth: number, numberOfLines: number) {
...
export function applyTextStyle(canvas: Vuvas, options: DrawTextOptions) {
...
export function measureText(canvas: Vuvas, options: DrawTextOptions): MeasureResult {
...
export function drawText(canvas: Vuvas, options: DrawTextOptions, lines: MeasureLine[]) {
