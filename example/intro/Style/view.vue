<template>
  <View :style="styles.container">
    ...
    <View cache pointerEvents="none">
      <Panel label="Box">
        <Box text="width: 200; height: 55" :boxStyle="styles.box.wh" />
        <Box text="backgroundColor: yellow" :boxStyle="styles.box.yellow" />
        <Box text="borderRadius: 10" :boxStyle="styles.box.radius" />
        <Box text="shadowOffsetX|Y\shadowColor\shadowBlur" :boxStyle="styles.box.shadow" />
        <Box text="borderWidth\borderColor" :boxStyle="styles.box.border" />
      </Panel>
      <Panel label="Layout">
